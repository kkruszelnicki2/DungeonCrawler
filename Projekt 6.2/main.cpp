...
int main()
{
    ...
    //Shopkeeper.position(window_width/2 - 23,window_height/2 - window_height/4);
    ///////////////////////////////////////////// BOSS //////////////////////////////////////////////////
    vector <boss*> Boss;
...
//               || ( sf::Keyboard::isKeyPressed(sf::Keyboard::Left) && Hero.get_pos_x() - Hero.get_speed() > 5 && !sf::Keyboard::isKeyPressed(sf::Keyboard::Right)
//                    && is_room[actual_room_x][actual_room_y].get_type() == "shop" && Hero.get_pos_x() + Hero.get_speed() > Shopkeeper.get_pos_x() + Shopkeeper.get_sizex() )  )
...
//               || ( sf::Keyboard::isKeyPressed(sf::Keyboard::Up) && Hero.get_pos_y() - Hero.get_speed() > 0)
//                    && is_room[actual_room_x][actual_room_y].get_type() == "shop" && Hero.get_pos_y() - Hero.get_speed() > Shopkeeper.get_pos_y()+Shopkeeper.get_sizey() )
            {
                Hero.move_up();
            }
            //  ///////////////////// DOL(bez zmian) ////////////////////////////////////
            if(sf::Keyboard::isKeyPressed(sf::Keyboard::Down) && Hero.get_pos_y() + Hero.get_speed() < window_height - 55)
//               || ( sf::Keyboard::isKeyPressed(sf::Keyboard::Right) && Hero.get_pos_y() + Hero.get_speed() < window_height - 55
//                    && is_room[actual_room_x][actual_room_y].get_type() == "shop" && Hero.get_pos_y() + Hero.get_speed() < Shopkeeper.get_pos_y() )  )
            {
                Hero.move_down();
            }
            ///////////////////////// STANIE W MIEJSCU ///////////////////////////////////
...
/////////////////////////////////////// ATAKI ///////////////////////////////////////////
            ...
            for(size_t i = 0; i < monsters.size(); i++)
            {
                ...
                {
                    bullets.push_back(new Bullet(monsters[i]->hitbox_pos_x + 5,monsters[i]->hitbox_pos_y + 15,monsters[i]->get_spell_damage(),"/Users/mcwilan/Library/Mobile Documents/com~apple~CloudDocs/pro3/Projekt cpp/Textures/Shooter_bullet.png",Hero.get_pos_x()+Hero.get_sizex()/2,Hero.get_pos_y()+Hero.get_sizey()/2));
        ...
        if(is_room[actual_room_x][actual_room_y].get_type() == "shop")
        {
            ...
            {
                Shopkeeper.bapanada_animation0();  // podniesienie glowy
                frame = 1;
                std::cout << Iselda_timer.getElapsedTime().asMilliseconds() << std::endl;
                Iselda_timer.restart();
            }
            else if(Iselda_timer.getElapsedTime().asMilliseconds() > 2*Iselda_animation_time && frame == 1)
            {
                Shopkeeper.bapanada_animation1();  // opuszczanie glowy
                frame = 2;
                std::cout << Iselda_timer.getElapsedTime().asMilliseconds() << std::endl;
                Iselda_timer.restart();
            ...
            {
                Shopkeeper.bapanada_animation2(); // podniesienie reki
                frame = 3;
                std::cout << Iselda_timer.getElapsedTime().asMilliseconds() << std::endl;
                Iselda_timer.restart();
            }
            ...
            {
                Shopkeeper.bapanada_animation3();  //opuszczenie reki
                frame = 4;
                std::cout << Iselda_timer.getElapsedTime().asMilliseconds() << std::endl;
                Iselda_timer.restart();
            }
