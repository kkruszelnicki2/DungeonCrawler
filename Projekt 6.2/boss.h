...
public:
    ...
    virtual void boss_action(hero *Hero, std::vector<Bullet*> *bullet,int window_width,int window_height,int wall_size_x,int wall_size_y, std::vector<boss*> *Boss, std::vector<pickups*> &pickup) {};
...
void boss::death(std::vector<pickups*> &pickups,int window_width,int window_height)
{
    ...
    pickups[0]->pickup.setPosition(window_width/2,window_height/2);
}
