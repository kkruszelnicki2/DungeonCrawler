...
public:
    ...
    void execute(bool &is_main_menu,sf::RenderWindow &window,bool &time,bool &restart, bool isAlive);
    void change_buttonAmount(int x);
    // Tlo menu
    sf::RectangleShape window;
    sf::Texture window_texture;
    std::string menu_dir = "/Users/mcwilan/Library/Mobile Documents/com~apple~CloudDocs/pro3/Projekt cpp/Textures/Portal.png";  // "/Users/mcwilan/Library/Mobile Documents/com~apple~CloudDocs/pro3/Projekt cpp/Textures/Portal.png"
    // Tytul gry
    sf::RectangleShape title;
    sf::Texture title_texture;
    std::string title_dir = "/Users/mcwilan/Library/Mobile Documents/com~apple~CloudDocs/pro3/Projekt cpp/Textures/Title.png";  // "/Users/mcwilan/Library/Mobile Documents/com~apple~CloudDocs/pro3/Projekt cpp/Textures/Title.png"
...
void menu::execute(bool &is_main_menu,sf::RenderWindow &window,bool &time,bool &restart, bool isAlive)
{
    if(buttons[index].name == "Play" && isAlive)
    {
        is_main_menu = false;
        time = true;
    }
