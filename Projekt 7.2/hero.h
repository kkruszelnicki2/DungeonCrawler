...
private:
    ...
    float size_x = 43;
    float size_y = 43;
    std::string knight_dir = "Knight.png"; //"/Users/mcwilan/Library/Mobile Documents/com~apple~CloudDocs/pro3/Projekt cpp/Textures/Knight.png"
...
public:
    ...
    void set_keyAmount(int x) {key_amount = key_amount+x; key_amoun.setString("x"+std::to_string(key_amount));}
...
hero::hero()
{
    ...
    key_texture.loadFromFile("/Users/mcwilan/Library/Mobile Documents/com~apple~CloudDocs/pro3/Projekt cpp/Textures/Key.png");  // "/Users/mcwilan/Library/Mobile Documents/com~apple~CloudDocs/pro3/Projekt cpp/Textures/Key.png"
    key.setTexture(&key_texture);
    key.setTextureRect(sf::IntRect(0, 0, 28, 12));
    key.setPosition(window_width/4,window_height-window_height/20);
    key.setSize(sf::Vector2f(14,6));
    key_amoun.setPosition(window_width/4 + window_width/35,window_height-window_height/13);
    key_amoun.setCharacterSize(15);
    key_amoun.setString("x0");
    key_amoun.setFont(font);
    font.loadFromFile("/Users/mcwilan/Library/Mobile Documents/com~apple~CloudDocs/pro3/Projekt cpp/Textures/font.ttf");  // "/Users/mcwilan/Library/Mobile Documents/com~apple~CloudDocs/pro3/Projekt cpp/Textures/font.ttf"
}
