...
hollow_knight::hollow_knight(int window_x)
{
    ...
    // Tekstura Hollow Knight'a
    boss_dir = "Hollow_knight.png"; // "/Users/mcwilan/Library/Mobile Documents/com~apple~CloudDocs/pro3/Projekt cpp/Textures/Hollow_knight.png"
...
void hollow_knight::boss_action(hero *Hero,std::vector<Bullet*> *bullets,int window_width,int window_height,int wall_size_x,int wall_size_y,std::vector<boss*> *Boss,std::vector<pickups*> &pickups,bool &boss_dead)
{
    ...
    if(cast==1 && spell_time.getElapsedTime().asSeconds()<spell_time1)
    {
        ...
        {
            // Tekstura pocisku Hollow Knight'a
