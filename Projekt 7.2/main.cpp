...
int main()
{
    ...
    std::string portal_dir = "Textures/Portal.png"; // "/Users/mcwilan/Library/Mobile Documents/com~apple~CloudDocs/pro3/Projekt cpp/Textures/Portal.png"
    ...
    /////////////////////////////////////////TEKSTY/////////////////////////////////////////////
    sf::Font font;
    font.loadFromFile("Textures/font.ttf");  // "/Users/mcwilan/Library/Mobile Documents/com~apple~CloudDocs/pro3/Projekt cpp/Textures/font.ttf"
    ...
    while (window.isOpen())
    {
        ...
        while (window.pollEvent(event))
        {
            ...
            if  (event.type == sf::Event::KeyPressed)
            {
                ...
                {
                    main_menu.execute(is_main_menu,window,time,restart);
                    if(restart)
                    {
                ...
                if(Hero.entity.getGlobalBounds().intersects(drzwi[i].getGlobalBounds()) && drawdoor[i] && !fight_mode)
                {
                    ...
                    switch(i)
                    {
                        case 0: // drzwi gorne(przechodzi w dolne)
                            ...
                            {
                                Hero.position(window_width / 2 - Hero.get_sizex()/2, window_height - Hero.get_sizey() - door_size_y);
                                actual_room_y--;
                            }
                        ...
                        case 1: // drzwi lewe(przechodzi w prawo)
                            ...
                            {
                                Hero.position(window_width - door_size_x -  Hero.get_sizex(), window_height / 2);
                                actual_room_x--;
                            }
                        ...
                        case 2: // drzwi prawe(przechodzi na lewo)
                            if(is_room[actual_room_x+1][actual_room_y].get_type()!="none" && is_room[actual_room_x+1][actual_room_y].can_enter())
                            {
                                Hero.position( door_size_x, window_height / 2);
                                actual_room_x++;
                            }
                            else if(is_room[actual_room_x+1][actual_room_y].get_type()=="treasure_room" && Hero.get_keyAmount()>0)
                            {
                        ...
                        case 3: // drzwi dolne(przechodzi w gorne)
                            if(is_room[actual_room_x][actual_room_y + 1].get_type()!="none" && is_room[actual_room_x][actual_room_y + 1].can_enter())
                            {
                                Hero.position(window_width / 2 - Hero.get_sizex()/2, door_size_y);
                                actual_room_y++;
                            }
                            else if(is_room[actual_room_x][actual_room_y + 1].get_type()=="treasure_room" && Hero.get_keyAmount()>0)
                            {
                    ...
                    if(!is_room[actual_room_x][actual_room_y].is_visited())
                    {
                        ...
                        else if(is_room[actual_room_x][actual_room_y].get_type() == "shop")
                        {
                            ...
                            is_room[actual_room_x][actual_room_y].pickups[2]->set_worth(2);
                        }
                        fight_mode = 1;
                    }
        ...
        if(time)
        {
            ...
            if(!Boss.empty())
            {
                Boss[0]->boss_action(&Hero,&bullets,window_width,window_height,wall_size_x,wall_size_y,&Boss,is_room[actual_room_x][actual_room_y].pickups,boss_dead);
            }
            /////////////////////////RUCH POTWOROW//////////////////////////////////
...
/////////////////////////////////////// ATAKI ///////////////////////////////////////////
            ...
            for(size_t i = 0; i < monsters.size(); i++)
            {
                ...
                {
                    // Tekstura pocisku strzelca: "/Users/mcwilan/Library/Mobile Documents/com~apple~CloudDocs/pro3/Projekt cpp/Textures/Shooter_bullet.png"
                    bullets.push_back(new Bullet(monsters[i]->hitbox_pos_x + 5, monsters[i]->hitbox_pos_y + 15, 5, 5, monsters[i]->get_spell_damage(),"Textures/Shooter_bullet.png",Hero.get_pos_x()+Hero.get_sizex()/2,Hero.get_pos_y()+Hero.get_sizey()/2));
                ...
                {
                    // Tekstura pocisku strzelca
                    bullets.push_back(new Bullet(monsters[i]->hitbox_pos_x + 5, monsters[i]->hitbox_pos_y + 15, 8, 12, monsters[i]->get_spell_damage(),"Textures/Grimmchild_bullet.png",Hero.get_pos_x()+Hero.get_sizex()/2,Hero.get_pos_y()+Hero.get_sizey()/2));
                    monsters[i]->detonate = false;
                }
            }
        ...
        window.draw(Hero.key);
        window.draw(Hero.key_amoun);
        if(is_main_menu)
        {
