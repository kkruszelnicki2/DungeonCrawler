...
class Bullet
{
    private:
        ...
        float trajectory[2];
    public:
        Bullet(float x,float y, int damage,std::string texture,float hero_pos_x,float hero_pos_y);
...
Bullet::Bullet(float x,float y, int dmg,std::string texture,float hero_pos_x,float hero_pos_y)
{
