...
public:
    ...
    virtual void boss_action(hero *Hero, std::vector<Bullet*> *bullet,int wall_size_x,int wall_size_y,std::vector<boss*> *Boss,std::vector<pickups*> &pickup,bool &boss_dead, std::vector<Entity*> &monsters) {};
