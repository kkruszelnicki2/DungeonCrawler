...
int main()
{
    ...
    while (window.isOpen())
    {
        ...
        if(time)
        {
            ...
            if(!Boss.empty())
            {
                Boss[0]->boss_action(&Hero,&bullets,wall_size_x,wall_size_y,&Boss,is_room[actual_room_x][actual_room_y].pickups,boss_dead,monsters);
            }
            /////////////////////////RUCH POTWOROW//////////////////////////////////
...
/////////////////////////////////////// ATAKI ///////////////////////////////////////////
            ...
            for(size_t i = 0; i < monsters.size(); i++)
            {
                ...
                if(monsters[i]->name == "grimmchild" && monsters[i]->detonate)
                {
                    ...
                    bullets.push_back(new Bullet(monsters[i]->hitbox_pos_x + 5, monsters[i]->hitbox_pos_y + 15, 16, 24, monsters[i]->get_spell_damage(),"Textures/Grimmchild_bullet.png",Hero.get_pos_x()+Hero.get_sizex()/2,Hero.get_pos_y()+Hero.get_sizey()/2));
                    monsters[i]->detonate = false;
                }
            }
