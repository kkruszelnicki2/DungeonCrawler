...
int main()
{
    ...
    while (window.isOpen())
    {
        ...
        if(time)
        {
            if(!Boss.empty())
            {
                Boss[0]->boss_action(&Hero,&bullets,window_width,window_height,wall_size_x,wall_size_y,&Boss);
            }
            /////////////////////////RUCH POTWOROW//////////////////////////////////
...
/////////////////////////////////////// ATAKI ///////////////////////////////////////////
            ...
            if(monsters.empty() && Boss.empty()) // dzialania po smierci ostatniego potwora
            {
                fight_mode = 0;
                for(int i = 0; i < 4; ++i)
                {
