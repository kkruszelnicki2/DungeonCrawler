...
int main()
{
    ...
    while (window.isOpen())
    {
        ...
        while (window.pollEvent(event))
        {
            ...
            {
                if(Hero.entity.getGlobalBounds().intersects(drzwi[i].getGlobalBounds()) && drawdoor[i] && !walka)
                {
                    switch(i)
                    {
                    ...
                    draw_door(is_room,drawdoor,actual_room_x,actual_room_y);
                    Hero.texture("Textures/Knight.png", 15, 6, 13, 27);
        ...
        if(time)
        {
            ...
            {
                if(!monsters[i]->entity.getGlobalBounds().intersects(Hero.hitbox.getGlobalBounds()))
                {
...
/////////////////////////////////////// ATAKI ///////////////////////////////////////////
            ...
            for(size_t i=0;i<monsters.size();i++)
            {
                if(Hero.attack_hitbox.getGlobalBounds().intersects(monsters[i]->entity.getGlobalBounds()) && Hero.get_attack() && !monsters[i]->get_protection())
                {
                ...
                if(Hero.hitbox.getGlobalBounds().intersects(monsters[i]->entity.getGlobalBounds()))
                {
        ...
        for(size_t i=0;i<monsters.size();i++) //rysowanie potworów
        {
